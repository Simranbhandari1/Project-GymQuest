  ...
  return (
    <main className="relative bg-gradient-to-b mt-12 from-black via-[#0f3e3b] to-black flex items-center justify-center min-h-screen">
      ...
      <div className="relative z-10 w-full max-w-sm px-4">
        <div className="flex w-full flex-col items-center justify-center rounded-xl overflow-hidden shadow-2xl border border-white/20 backdrop-blur-xl bg-white/10 p-10">
